...
<head>
  ...
  <title>Dashboard - TATIANA Apparel</title>
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Recent Sales <a href="#" class="fw-bold text-dark">Admin changed customer status for #2457 from 'Pending' to </a> 'Approved'
                  </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Recent Sales Admin changed customer status for #2644 from 'Pending' to 'Rejected'
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Reports  <a href="#" class="fw-bold text-dark">Sales increased at </a> 5:30 pm!
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Janneth Esguerra Yung sa faqs ako sana kaso waiting pa me sa reply ni ate
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Cristel Jane Navarro Ako na lng mag send
                  </div>
                </div><!-- End activity item-->
          ...
          <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form>
                      <div class="row mb-3">
                        <label for="inputText">Product title:*</label>
                        <div class="col-sm-10">
                          <input type="text" placeholder="Brown gingham dress" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="number" placeholder="64" class="form-control" required>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="inputNumber" >Count In Stock:*</label>
                        <div class="col-sm-10">
                          <input type="number" placeholder="100" class="form-control" required>
                        </div>
                      </div>
                      <div class="row mb-3">
            ...
            <div class="card-body pb-0">
              ...
              <div class="news">
                <div class="post-item clearfix">
                  <img src="assets/img/news-6.png" alt="">
                  <h4><a href="https://www.preview.ph/fashion/instagram-thrift-shops-for-neutrals-a2146-20211129">6 Instagram Ukay-Ukay Stores to Shop for Chic Neutral Pieces</a></h4>
                  <p>Tatiana Apparel will be your go-to store if you want to achieve a picnic-inspired outfit. The store offers sweet floral skirts, romantic cowl neck dresses, and chic tops that'll make you want to comment "mine" nonstop!</p>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/news-1.png" alt="">
                  <h4><a href="#">TATIANA Apparel basic, but make it sexy.</a></h4>
                  <p>sharing with you today one of our fave photo from yesterday fun shooot! literally moved all the furnitures inside the house just to come up with these photos!!! days are going by soooo fasttt. WATCH US GO LIVE TOMORROW AT EXACTLY 6 PM! SEE YOUUU.</p>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/news-2.png" alt="">
                  <h4><a href="#">LIVE COLLECTION tatiana.apparel x olt.btn final preview july 16 at 6pm.</a></h4>
                  <p>Finallyyy officially showing you guys some of the gems that will be up on our live this friday! we both couldnt be more excited to chat and have fun with you guys ♡ alsooo were about to have surprises for youuu!</p>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/news-3.png" alt="">
                  <h4><a href="#">TATIANA Apparel, yesss to our first teaser of the month!</a></h4>
                  <p>Finally started our june collection today ft. this super comfy and asethetic outfit that is on trend rn! this time, we curated more pieces than our usual.</p>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/news-4.png" alt="">
                  <h4><a href="#">TATIANA Apparel one hour away before we officially gooo liveeee!</a></h4>
                  <p>Heres another full outfit moment that you should keep an eye on later as we show all the pieces we have from olt and tatiana mini collection.</p>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/img/news-5.png" alt="">
                  <h4><a href="#">TATIANA Apparel, back early not for another collection.</a></h4>
                  <p>A lot of cutee finds you never thought you needed are in store for everyone in 3 days. Swipeee to have a quick glimpse of what we are having on Friday!</p>
                </div>
